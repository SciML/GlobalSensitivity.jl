...
@test res2.S1 ≈ [0.307599 0.442412 3.0941e-25 3.42372e-28] atol = 1.0e-4
...
@test res2.S1 ≈ [0.09791555320248665 0.7489863459743518 1.2521202417363353e-7 1.8830074456723684e-6] atol = 1.0e-1
...
@test res2.S1 ≈ [0.997504 0.000203575 2.1599e-10 2.18296e-10] atol = 1.0e-4

@test res1.ST ≈ [0.999796 0.000204698 7.26874e-7 7.59996e-7] atol = 1.0e-4
@test res2.ST ≈ [0.999796 0.000204698 7.26874e-7 7.59996e-7] atol = 1.0e-4
...
@test res1.S1 ≈ [
    0.307595 0.442411 7.75353e-26 2.3468e-28
    0.997498 0.000203571 3.18996e-35 4.19822e-35
] atol = 1.0e-4
@test res2.S1 ≈ [
    0.307598 0.442411 5.27085e-26 3.50751e-29
    0.997498 0.000203571 1.08441e-34 9.90366e-35
] atol = 1.0e-4

@test res1.ST ≈ [
    0.556246 0.446861 0.239258 0.027104
    0.999796 0.00020404 6.36917e-8 6.34754e-8
] atol = 1.0e-4
@test res2.ST ≈ [
    0.556243 0.446861 0.239258 0.0271024
    0.999796 0.00020404 6.35579e-8 6.36016e-8
] atol = 1.0e-4
